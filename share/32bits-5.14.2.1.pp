  ...
  build_job_steps => [
    ...
    ### STEP 3 ###########################
    {
        ...
        exceptions => [ # match: version distribution cpan_file
          ...
          #{ do=>'skip',               distribution => qr/^CPANPLUS$/ } },
          #{ do=>'skiptest',           distribution => 'IPC-Cmd' },
    ...
    ### STEP 5 ###########################
    {
       ...
       commands => [
         ...
         { do=>'apply_tt', args=>[ '<dist_sharedir>/perl-5.16/CPAN_Config.pm.tt', '<image_dir>/perl/lib/CPAN/Config.pm', {}, 1 ] }, #XXX-temporary empty tt_vars, no_backup=1
    ...
    ### STEP 11 ###########################
    {
       ...
       commands => [ # files and dirs specific to portable edition
         ...
         { do=>'copyfile',   args=>[ '<dist_sharedir>/portable/README.portable.txt', '<image_dir>/README.portable.txt' ] },
